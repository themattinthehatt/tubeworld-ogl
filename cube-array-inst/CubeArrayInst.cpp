 ...
 */
CubeArrayInst::CubeArrayInst(int numCubesX_, int numCubesY_, int numCubesZ_,
    ...
    if (isTextureRendered) {
        ...
        // create and compile our GLSL program from the shaders
        shaderID = loadShaders("cube-array-inst/SolidShader.vert",
                               "cube-array-inst/SolidShader.frag");
    }
...
//                    g_vertex_buffer_data, g_center_buffer_data);
    ...
    createHollowCubeArrayVec(numCubesX, numCubesY, numCubesZ,
 ...
 */
CubeArrayInst::~CubeArrayInst() {}

/*
 * update()
 * Update position of cube array
 */
void CubeArrayInst::update(const Camera &cam) {
    time = glfwGetTime();
    mMatrix = glm::mat4(1.0);
 ...
 */
void CubeArrayInst::createCubeArray(int numCubesX, int numCubesY, int numCubesZ,
...
void CubeArrayInst::createHollowCubeArrayVec(int numCubesX, int numCubesY, int numCubesZ,
                                             glm::vec3 center_buffer_data[])
{
    int counter = 0;
    float scale = 5.0f;
 ...
 */
void CubeArrayInst::createSTArray(int numCubes, int numVertices,
                                    GLfloat *buffer_data)
{
        ...
        for (int j = 0; j < numVertices; ++j) {
            ...
            for (int k = 0; k < 2; ++k) {
                buffer_data[fullVertexCount + k] =
                        CubeArrayInst::cubeSTCoordinates[modelVertexCount + k];
            }
        }
    }
}

GLfloat CubeArrayInst::cubeModelCoordinates[] = {
...
GLfloat CubeArrayInst::cubeSTCoordinates[] = {
