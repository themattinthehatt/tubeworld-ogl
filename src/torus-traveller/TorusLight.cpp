...
TorusLight::TorusLight(GLuint shaderID_) {
...
// update
void TorusLight::update(Camera &cam) {

    // update lamp position
    lightProps.cameraPosition = cam.getPosition();
    lightProps.position = glm::vec3(0.f, 10.f, 0.f);
