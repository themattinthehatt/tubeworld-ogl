...
SimpleShapes::SimpleShapes(GLint numCenters_, RingModelType ringModelType_)
        :
    ...
    switch (ringModelType) {
        case SQUARE_OF_SQUARES: {
            // load cube model
            bool res = loadObj("data/obj/cube.obj", cubeModelCoordinates,
                               uvs, normals);
 ...
 */
void SimpleShapes::update(const PathGenerator *path, Camera &cam ) {
